...
protected:  //needs to be protected in order to access data from derived class
 /// Pointer to the actual data.
	T* data_;  //changed to type T because it was orginally char
...
#include "basic_array.cpp"  //had to comment this line out in order to compile my driver when running only the array class I was getting the c2995 error is this called circular inheritance? 
