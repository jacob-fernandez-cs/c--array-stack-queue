 ...
 */
template <typename T>
class Stack : public Array <T> //needs to inherit Array
{
public:
...
#include "Stack.cpp" //had to comment this line out in order to compile my driver when running only the array class I was getting the c2995 error is this called circular inheritance? 
